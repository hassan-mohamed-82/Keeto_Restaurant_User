...
const cashierMan_1 = require("./cashierMan");
exports.cashiers = (0, mysql_core_1.mysqlTable)("cashiers", {
    ...
    cashierManId: (0, mysql_core_1.char)("cashier_man_id", { length: 36 }).references(() => cashierMan_1.cashierMen.id, { onDelete: "set null" }),
