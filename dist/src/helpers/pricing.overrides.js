...
function cascadeOverrideCondition(table, branchId, serviceModule) {
    const candidates = [
        (0, drizzle_orm_1.and)((0, drizzle_orm_1.eq)(table.branchId, branchId), (0, drizzle_orm_1.isNull)(table.serviceModule)),
    ];
    if (serviceModule) {
        candidates.push((0, drizzle_orm_1.and)((0, drizzle_orm_1.eq)(table.branchId, branchId), (0, drizzle_orm_1.eq)(table.serviceModule, serviceModule)), (0, drizzle_orm_1.and)((0, drizzle_orm_1.isNull)(table.branchId), (0, drizzle_orm_1.eq)(table.serviceModule, serviceModule)));
    }
    return (0, drizzle_orm_1.or)(...candidates);
}
...
async function fetchFoodOverrides(dbOrTx, foodId, branchId, serviceModule) {
    return dbOrTx
        ...
        .from(channelPricing_1.foodPricingOverrides)
        .where((0, drizzle_orm_1.and)((0, drizzle_orm_1.eq)(channelPricing_1.foodPricingOverrides.foodId, foodId), (0, drizzle_orm_1.eq)(channelPricing_1.foodPricingOverrides.status, "active"), cascadeOverrideCondition(channelPricing_1.foodPricingOverrides, branchId, serviceModule)));
}
async function fetchVariantOverrides(dbOrTx, variantIds, branchId, serviceModule) {
    ...
    return dbOrTx
        ...
        .from(channelPricing_1.variantPricingOverrides)
        .where((0, drizzle_orm_1.and)((0, drizzle_orm_1.inArray)(channelPricing_1.variantPricingOverrides.variantId, variantIds), (0, drizzle_orm_1.eq)(channelPricing_1.variantPricingOverrides.status, "active"), cascadeOverrideCondition(channelPricing_1.variantPricingOverrides, branchId, serviceModule)));
}
