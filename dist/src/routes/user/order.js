...
const order_2 = require("../../validation/user/order");
const router = (0, express_1.Router)();
router.post("/checkout", (0, validation_1.validate)(order_2.checkoutSchema), (0, catchAsync_1.catchAsync)(order_1.checkout));
