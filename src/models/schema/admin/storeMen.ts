...
export const storeMen = mysqlTable(
    "store_men",
    {
    ...
    (table) => ({
        restaurantPhoneIdx: uniqueIndex("uk_store_men_restaurant_phone").on(
            table.restaurantId,
            table.phone
        ),
        restaurantNameIdx: uniqueIndex("uk_store_men_restaurant_name").on(
            table.restaurantId,
            table.name
        ),
    })
