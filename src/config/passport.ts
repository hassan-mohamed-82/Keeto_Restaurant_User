...
export const verifyGoogleToken = async (req: Request, res: Response) => {
  ...
  try {
    ...
    if (!user) {
      ...
      user = { id: newId, name, email, googleId, phone: null, alternatePhone: null, photo: null, fcmToken: null, password: null, isVerified: true, status: "active", createdAt: new Date(), facebookId: null };
    } else {
      // 👤 Login (existing user)
